...
def run_test_practice_problem2a():
    ...
    # Test1:
    sequence = [1, 2, 3, 5, 6, 7, 135]
    delta = 7
    expected = [8, 9, 10, 12, 14, 142]
    ...
    sequence = [1, 5, 2, 9]
    delta = 1720
    expected = [1721, 1725, 1722, 1729]
    actual = practice_problem2a(sequence, delta)
    print('actual:', actual)
    print('expected', expected)

    # Test3:
    sequence = [3, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33]
    delta = 2
    expected = [5, 8, 11, 14, 17, 20, 23, 26, 29, 32, 35]
    actual = practice_problem2a(sequence, delta)
    print('actual:', actual)
    print('expected', expected)

    # Test4:
    sequence = [1, 9, 17, 25, 33, 41]
    delta = 5
    expected = [6, 14, 22, 30, 38, 46]
    actual = practice_problem2a(sequence, delta)
    print('actual:', actual)
    print('expected', expected)
